...
import { generateMockApplications } from "./fixtures";
...
export class MockPlanningProvider implements PlanningDataProvider {
  // Generated once per process (module-scope cache below), not per call —
...
/** Module-scope cache: one generated dataset per server process. */
