...
function residentialHomeowner(): ContactStrategy {
  return {
    ...
    explanation: "No planning professional is visible on the record. The platform should use the project address for postal outreach and avoid attempting to discover a homeowner's private email or mobile number.",
    useApplicantNameForPostal: false,
    allowConsumerEnrichment: false,
...
function unknown(hasAgent: boolean): ContactStrategy {
  return {
    ...
    explanation: "The platform has not seen enough reliable evidence to classify this as homeowner, company, developer or public-sector work. It should not infer personal contact details from uncertainty.",
    useApplicantNameForPostal: false,
    allowConsumerEnrichment: false,
