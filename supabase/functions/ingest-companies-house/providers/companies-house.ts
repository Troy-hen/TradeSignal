import { defaultRights, sha256, type NormalizedProviderRecord, type ProviderAdapter, type ProviderSourceRecord } from "./types.ts";
...
export class CompaniesHouseAdapter implements ProviderAdapter {
  ...
  async fetch(request: { limit?: number; query?: string | null }): Promise<ProviderSourceRecord[]> {
