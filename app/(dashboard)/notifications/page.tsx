...
export default async function NotificationsPage() {
  ...
  return (
    <div className="min-w-0 space-y-8">
      <AppPageHeader eyebrow="Action centre" title="Follow up on the signals you chose." description="Reminders and delivery history live here. Discovery and unlocking stay in the marketplace, so this page does not duplicate the feed." actions={<Link href="/opportunities" className="inline-flex items-center justify-center rounded-xl bg-signal-orange px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#e95f00]">Open marketplace <span className="ml-2">→</span></Link>} stats={[{ label: "Follow-ups due", value: String(reminders.length), detail: "Next actions" }, { label: "Delivery events", value: String(notifications.length), detail: "Alert history" }, { label: "Marketplace", value: "Live", detail: "New matches appear there" }]} />
