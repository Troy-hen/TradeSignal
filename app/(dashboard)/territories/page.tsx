    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-slate sm:text-base">
          Search any UK postcode district and trade to see local planning activity, estimated value and whether the
          exclusive territory is available.
        </p>
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
        ...
        <section className="rounded-3xl bg-charcoal p-6 text-white sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold tracking-tight sm:text-3xl">One trade. One postcode district. One clear opportunity feed.</h2>
          <p className="mt-4 text-sm leading-6 text-white/65 sm:text-base">
            MyTradeBox keeps the feed focused by giving one business exclusive access to each trade and postcode
            combination.
          </p>
