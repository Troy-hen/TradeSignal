...
export default async function TerritoryDetailPage({ params }: { params: Promise<{ postcodeDistrict: string; tradeSlug: string }> }) {
  ...
  return (
    <div className="min-w-0 space-y-8">
      <Link href="/opportunities?view=map" className="inline-flex items-center gap-2 text-sm font-semibold text-slate transition hover:text-charcoal">← Marketplace map</Link>
