...
export default async function BillingPage() {
  ...
  return (
    <div className="space-y-8">
      <div><p className="text-xs font-semibold uppercase tracking-[0.16em] text-signal-orange">Account</p><h1 className="mt-3 text-3xl font-bold tracking-tight text-charcoal sm:text-4xl">Billing.</h1><p className="mt-3 max-w-2xl text-sm leading-6 text-slate sm:text-base">Manage your TradeSignal platform subscription, individual opportunity unlocks, payment details and invoices.</p></div>
