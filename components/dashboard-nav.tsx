...
function NavIcon({ name, active }: { name: string; active: boolean }) {
  ...
  if (name === "purchased") return <svg viewBox="0 0 24 24" className={c} fill="none" stroke="currentColor" strokeWidth="1.8"><path strokeLinecap="round" strokeLinejoin="round" d="M5 7.5h14v12H5z"/><path strokeLinecap="round" d="M8 7.5V5.75A1.75 1.75 0 0 1 9.75 4h4.5A1.75 1.75 0 0 1 16 5.75V7.5M8 12h8M8 16h5"/></svg>;
