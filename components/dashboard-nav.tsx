...
const NAV_ITEMS = [
  ...
  { href: "/territories", label: "Explore territories", icon: "territories" },
  { href: "/coverage", label: "My coverage", icon: "claimed" },
...
function isActive(pathname: string, href: string): boolean { if (href === "/dashboard") return pathname === "/dashboard"; return pathname === href || pathname.startsWith(`${href}/`); }
function NavIcon({ name, active }: { name: string; active: boolean }) {
  ...
  if (name === "data") return <svg viewBox="0 0 24 24" className={c} fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M5 6.5C5 4.8 8.1 3.5 12 3.5s7 1.3 7 3v11c0 1.7-3.1 3-7 3s-7-1.3-7-3v-11Z"/><path d="M5 6.5c0 1.7 3.1 3 7 3s7-1.3 7-3M5 12c0 1.7 3.1 3 7 3s7-1.3 7-3"/></svg>;
  if (name === "roi") return <svg viewBox="0 0 24 24" className={c} fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M4 19V5M4 19h16"/><path d="m7 15 3-3 3 2 5-6"/><path d="M15 8h3v3"/></svg>;
